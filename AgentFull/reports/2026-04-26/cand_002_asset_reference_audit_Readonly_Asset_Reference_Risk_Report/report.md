...
- Generated At: 2026-04-26T16:05:01
- Task: `auto_discover_and_implement`
- Task ID: `auto_discover_and_implement_160450`
- Report Directory: `D:\LAB\Unity\RandomWorld\Assets\AgentFull\reports\2026-04-26\cand_002_asset_reference_audit_Readonly_Asset_Reference_Risk_Report`
...
- ID: `cand_002_asset_reference_audit`
- Name: Readonly Asset Reference Risk Report
- Risk: low
- Type: report_tool
...
```json
{
  "task_goal": "Readonly Asset Reference Risk Report",
  "candidate_id": "cand_002_asset_reference_audit",
  "description": "Scan prefab, scene, material, and ScriptableObject YAML files for empty GUIDs, missing script markers, and suspicious local references.",
  ...
  "modify_files": [],
  "new_files": [
    "D:\\LAB\\Unity\\RandomWorld\\Assets\\Editor\\ReadonlyAssetReferenceRiskReport.cs"
  ],
  "risk_notes": [
    "Risk level: low",
  ...
  "selected_at": "2026-04-26T16:04:50"
}
```
...
- `D:\LAB\Unity\RandomWorld\Assets\Editor\ReadonlyAssetReferenceRiskReport.cs.meta`
...
```json
{
  ...
  "checks": [
    {
      "path": "D:\\LAB\\Unity\\RandomWorld\\Assets\\Editor\\ReadonlyAssetReferenceRiskReport.cs",
      "exists": true,
