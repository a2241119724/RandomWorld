namespace LAB2D.AI.Dialogue.LLM
{
    ...
    public static class LLMClientConfig
    {
        ...
        /// 默认内置模型文件名
        /// </summary>
        public const string DEFAULT_MODEL_FILE = ResourceConstant.BUILTIN_LLM_MODEL_FILE;

        /// <summary>
        /// 默认内置模型在 StreamingAssets 下的相对路径
        /// </summary>
