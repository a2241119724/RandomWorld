...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            // 添加 TMP 组件时对 Transform 的引用将丢失，因为它会被 RectTransform 替换。
        ...
        {
            float CountDuration = 2.0f; // 倒计时持续的时间。
            float starting_Count = Random.Range(5f, 20f); // 计数器从哪个数字开始。
            ...
            while (current_Count > 0)
            {
                ...
                if (current_Count <= 3)
                {
                    //Debug.Log("计数器正在淡出... " + current_Count.ToString("f2"));
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                //Debug.Log("当前计数:" + current_Count.ToString("f2"));
