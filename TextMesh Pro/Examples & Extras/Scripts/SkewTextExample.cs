...
namespace TMPro.Examples
{
    ...
    public class SkewTextExample : MonoBehaviour
    {
        ...
        IEnumerator WarpText()
        {
            ...
            m_TextComponent.havePropertiesChanged = true; // 需要强制更新 TextMeshPro 对象。
            CurveScale *= 10;
            ...
            while (true)
            {
                ...
                m_TextComponent.ForceMeshUpdate(); // 生成网格并用可用的数据填充 textInfo。
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // 根据动画曲线计算每个字符的旋转角度
                    float x0 = (offsetToMidBaseline.x - boundsMinX) / (boundsMaxX - boundsMinX); // 字符相对于网格边界的位置。
                    float x1 = x0 + 0.0001f;
