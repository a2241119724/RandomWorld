...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            ...
            // 强制生成文本对象 so we have valid data to work with. This is needed since LateUpdate() will be called before the text object has a chance to generated when entering play mode.
        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    // 以下是访问链接属性的示例。
                    //Debug.Log("Link ID: \"" + linkInfo.GetLinkID() + "\"   Link Text: \"" + linkInfo.GetLinkText() + "\""); // 检索链接 ID 和链接文本的示例。
